...
def noun_stats(inputFilename, outputDir, data, data_divided_sents, openOutputFiles, chartPackage, dataTransformation):
    ...
    startTime=IO_user_interface_util.timed_alert('Analysis start', 'Started running NOUN ANALYSES at',
                                                 True, '', True, '', True)
    ...
    IO_csv_util.df_to_csv(df1, noun_list_file_name, headers=['Form', 'Lemma', 'POS'], index=False,
    ...
    IO_csv_util.df_to_csv(df, noun_postag_list_file_name, headers=headers, index=False,
                          language_encoding='utf-8')
    ...
    IO_csv_util.df_to_csv(df, noun_ner_list_file_name, headers=headers, index=False,
                          language_encoding='utf-8')
    ...
    IO_csv_util.df_to_csv(df, noun_deprel_list_file_name, headers=headers, index=False,
                          language_encoding='utf-8')
